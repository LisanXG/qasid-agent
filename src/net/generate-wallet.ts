...
const envContent = `# Generated by QasidAI wallet generator — ${new Date().toISOString()}
# ⚠️  DELETE THIS FILE after copying the key to your .env
...
╚═══════════════════════════════════════════════════════════╝
  ...
  🔑 Private key saved to: .env.generated
  ...
  🔐 SECURITY: The private key was NOT printed to your terminal.
